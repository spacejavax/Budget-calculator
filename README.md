...
My friend also tried to create a game in Pygame to later import to the React Website using Pygbag, but it did not end up working. While the Pygbag game loaded and worked on her own computer, it just kept loading in the React website and did not end up working. 
